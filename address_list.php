 ...
 */ {
    ...
    $sql = mysql_query("INSERT INTO indirizzo ( user_id, via, civico, appart, citta, cap, provincia, regione) 
        VALUES ( '$userid', '$via', '$civico', '$appartamento', '$citta', '$cap', '$provincia','$regione')") or die(mysql_error());
